...
import { PhoneSignInFormComponent } from './forms/phone-sign-in-form/phone-sign-in-form.component';
  ...
  providers: [
    {
      ...
      useValue: { duration: 5000, panelClass: 'snackbar' },
    },
  ],
})
